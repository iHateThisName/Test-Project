...
namespace Gaskellgames
{
    ...
    public static class GgMaths
    {
        ...
        /// <summary>
        /// Get the capsule points for a given capsule collider.
        /// </summary>
        /// <param name="capsule">The capsule collider.</param>
        /// <param name="point1">The centre of the end-sphere that defines the top of the capsule.</param>
        /// <param name="point2">The centre of the end-sphere that defines the bottom of the capsule.</param>
        public static void GetCapsulePoints(this CapsuleCollider capsule, out Vector3 point1, out Vector3 point2)
        {
            float offset = Mathf.Max(0, capsule.height - (2 * capsule.radius)) * 0.5f;
            Vector3 pointOffset = capsule.transform.up.normalized * offset;
            point1 = capsule.center - pointOffset;
            point2 = capsule.center + pointOffset;
        }
        
        /// <summary>
        /// Get the capsule points that are defined by a given centre, up, radius and height of a capsule.
        /// </summary>
        ...
        /// <param name="point1">The centre of the end-sphere that defines the top of the capsule.</param>
        /// <param name="point2">The centre of the end-sphere that defines the bottom of the capsule.</param>
        public static void GetCapsulePoints(Vector3 center, Vector3 up, float radius, float height, out Vector3 point1, out Vector3 point2)
        {
            float offset = Mathf.Max(0, height - (2 * radius)) * 0.5f;
            Vector3 pointOffset = up.normalized * offset;
            point1 = center - pointOffset;
            point2 = center + pointOffset;
        }
        ...
        /// <param name="onSurface">If true then the projected point will always be on the outline of the sphere.</param>
        /// <returns></returns>
        public static Vector3 ProjectPointToSphere(Vector3 point, Vector3 center, float radius, bool onSurface)
        {
            Vector3 direction = point - center;
            float magnitude = onSurface ? radius : Mathf.Clamp(direction.magnitude, 0, radius);
            return center + (direction.normalized * magnitude);
        }
        ...
        /// <param name="radius">The radius of the capsule in world space units.</param>
        /// <param name="height">The height of the capsule in world space units.</param>
        /// <param name="onSurface">If true then the projected point will always be on the outline of the capsule.</param>
        /// <returns></returns>
        public static Vector3 ProjectPointToCapsule(Vector3 point, Vector3 center, Vector3 up, float radius, float height, bool onSurface)
        {
            float offset = Mathf.Max(0, height - (2 * radius)) * 0.5f;
            Vector3 pointOffset = up.normalized * offset;
            return ProjectPointToCapsule(point, center - pointOffset, center + pointOffset, radius, onSurface);
        }
        ...
        /// <param name="onSurface">If true then the projected point will always be on the outline of the capsule.</param>
        /// <returns></returns>
        public static Vector3 ProjectPointToCapsule(Vector3 point, Vector3 capsulePoint1, Vector3 capsulePoint2, float radius, bool onSurface)
        {
            ...
            float magnitude = onSurface ? radius : Mathf.Clamp(direction.magnitude, 0, radius);
            return projectedPointOnLine + (direction.normalized * magnitude);
        }
