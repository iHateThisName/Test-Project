...
namespace Gaskellgames
{
    ...
    internal class UnitDrawer : GgPropertyDrawer
    {
        ...
        {
            GUIContent label = new GUIContent("", units.ToString().NicifyName());
            ...
            switch (units)
            {
                ...
                case Units.PerSecondSquared:
                    label.text = "/s\u00B2";
                    break;
                case Units.UnitsPerSecondSquared:
                    label.text = "u/s\u00B2";
                    break;
                case Units.DegreesPerSecondSquared:
                    label.text = "\u00B0/s\u00B2";
                    break;
                case Units.RadiansPerSecondSquared:
                    label.text = "rad/s\u00B2";
                    break;
