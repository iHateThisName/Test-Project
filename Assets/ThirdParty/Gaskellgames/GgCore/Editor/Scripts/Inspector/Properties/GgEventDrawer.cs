    ...
    public class GgEventDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (property.isExpanded)
            {
                ...
                EditorGUI.LabelField(footNote, new GUIContent($"Count: {ggEvent.GetPersistentEventCount()}", listenerTooltip), GgGUI.SubLabelStyle);
            }
            ...
            EditorGUI.LabelField(headerNote, new GUIContent($"({ggEvent.GetPersistentEventCount()})", listenerTooltip), GgGUI.SubLabelStyleRight);
